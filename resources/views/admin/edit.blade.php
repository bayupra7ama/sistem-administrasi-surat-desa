        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update', $penduduk) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="inputName">Nama Lengkap<span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" id="inputName" placeholder="" value="{{ $penduduk->name }}">
                                @error('name')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror"
                                        name="nik" oninput="this.value = this.value.replace(/\D/g, '')" id="Nik"
                                        value="{{ $penduduk->nik }}">
                                    @error('nik')
                                        <div class="invalid-feedback">{{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('kk') is-invalid @enderror"
                                        name="kk" oninput="this.value = this.value.replace(/\D/g, '')" id="kk"
                                        value="{{ $penduduk->kk }}">
                                    @error('kk')
                                        <div class="invalid-feedback">{{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        name="alamat" id="alamat" value="{{ $penduduk->alamat }}">
                                    @error('dusun')
                                        <div class="invalid-feedback">{{ $message }}
                                        </div>
                                    @enderror
                                ...
                                <div class="form-group col-md-6">
                                    <label for="RW">Dusun<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('dusun') is-invalid @enderror"
                                        name="dusun" id="dusun" value="{{ $penduduk->dusun }}">
                                    @error('dusun')
                                        <div class="invalid-feedback">{{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="form-group">
                                <label for="image1">file_file_foto</label>
                                ...
                                @if ($penduduk->photo_path)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $penduduk->photo_path) }}"
                                            alt="file_file_foto Penduduk" class="img-thumbnail" style="width: 150px;">
                                        <p>file_file_foto lama akan tetap digunakan jika tidak diubah.</p>
                                    </div>
                                @endif
                            </div>
